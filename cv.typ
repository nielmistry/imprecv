...
#let cvheading(info, uservars) = {
  ...
  table(
    ...
    stroke: none,
    align: horizon,
    box(clip: true, radius: rad, width: rad * 2, height: rad * 2, image(info.personal.image)),
    align(center)[
      = #info.personal.name
      ...
      #for org in info.affiliations {
        ...
        block(width: 100%, breakable: isbreakable)[
          // Line 1: Organization and Location
            ...
            #underline[*#link(org.url)[#org.organization]*] #h(1fr) *#org.location* \
          ] else [
            #underline[*#org.organization*] #h(1fr) *#org.location* \
          ]
    ...
    block(breakable: isbreakable)[
      == #title
        ...
        #for group in info.skills [
          - *#group.category*: #eval(group.skills.join(", "), mode: "markup")
        ]
      ]
      #if ("interests" in info) and (info.interests != none) [
        - *Interests*: #eval(info.interests.join(", "), mode: "markup")
      ]
    ]
  }
}
